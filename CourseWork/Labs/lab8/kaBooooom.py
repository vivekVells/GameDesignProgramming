...
class StopBlock(pygame.sprite.Sprite):
    """ This class represents the stop block"""
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        # rectangular frame enclosing the bullet
        self.image = pygame.Surface([RECT_FRAME_WIDTH, RECT_FRAME_HEIGHT])
        self.image.fill(GREEN)

        # bullet centered to the rectangular frame width
        pygame.draw.rect(self.image, BLACK, [(RECT_FRAME_WIDTH/2) - 2, 0, BULLET_WIDTH, BULLET_HEIGHT])
